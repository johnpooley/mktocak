            ...
            <div>
                <div style={{height:'fit-content',padding:'25px',backgroundColor:'#2c3e40',color:'white'}}>
                    <div style={{display:'inline-block'}}>
                        ...
                        <a href='/contribute' style={{color:'whitesmoke',textAlign:'center',display:'block'}}>Do you know bike paths or places that are not on the map?</a>
                    </div>
                    <div style={{display:'inline-block',verticalAlign:'top',margin:'30px',marginBottom:'0px'}}>
                        ...
                        <p style={{display:'block',fontSize:'9px',textAlign:'center'}}>The full-screen option is not supported for mobile phones</p>
                    </div>
                </div>
            </div>
        )
